...
const countOrderMonth = [
  ...
  const countUser = async () => {
      try {
          const res = await fetch('https://backenddt-main.onrender.com/user/get-count');
  ...
  const [countOrdersums, setCountOrdersum] = useState([
    ...
    try {
        const res = await fetch('https://backenddt-main.onrender.com/order/get-sum-moth');
        const data = await res.json(); // Chuyển đổi phản hồi sang JSON
  ...
  const countOrder = async () => {
    try {
        const res = await fetch('https://backenddt-main.onrender.com/order/get-total-orders');
        const data = await res.json(); // Chuyển đổi phản hồi sang JSON
