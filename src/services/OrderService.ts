...
export class OrderService {
    ...
    static async getAllOrders(): Promise<Order[]> {
        try {
            const response = await fetch('https://backenddt-main.onrender.com/api/order', {
    ...
    static async getOrderByID(orderId: number): Promise<Order | null> {
        try {
            const response = await fetch(`https://backenddt-main.onrender.com/api/order/${orderId}`, {
        ...
        static async searchorder(formData: string): Promise<any> {
            try {
                const response = await fetch('https://backenddt-main.onrender.com/api/order/search', {
                    method: 'POST',
                    headers: {
    ...
    static async getOrdersByUserId(userid: string): Promise<any> {
        try {
            const response = await fetch('https://backenddt-main.onrender.com/api/order/byuser', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    static async createOrder(newOrder: Order): Promise<Order> {
        try {
            const response = await fetch('https://backenddt-main.onrender.com/api/order/creater', {
    ...
    static async showorderdetail(id: string): Promise<any> {
        try {
            const response = await fetch(`https://backenddt-main.onrender.com/api/orderdetail/get?id=${id}`, {
        ...
        static async updateStatus(datapost:any): Promise<any> {
            try {
                ...
                const response = await fetch('https://backenddt-main.onrender.com/api/order/update', {
        ...
        static async getFullOrdersByOrderId(orderId: number): Promise<any> {
            try {
                ...
                const url = `https://backenddt-main.onrender.com/api/orderdetail/get?id=${orderId}`;
