    ...
    <div className="banner-item-two__slider">
        <Slider {...settings}>
            <div className="banner-item-two">
                <img
                    src="https://file.hstatic.net/200000722513/file/msi_web_collection_1920x450_2048x2048.png"
                    alt=""
            ...
            <div className="banner-item-two">
                <img
                    src="https://file.hstatic.net/200000722513/file/msi_web_collection_1920x450_2048x2048.png"  // Thay đổi đường dẫn ảnh cho slide tiếp theo
                    alt=""
